...
var playCricket = readlineSync.question(
  chalk.hex("#E5BA0D")("DO you play cricket ")
);
...
function play(question, answer, option, correctAnswer) {
  ...
  var userAnswer = readlineSync.question(
    chalk.hex("#E5BA0D")("Choose The Correct Options: ")
  );
  ...
  if (userAnswer.toUpperCase() == answer.toUpperCase()) {
    ...
    console.log(
      `The correct answer is: ${chalk.hex("#ffd369")(correctAnswer)}`
    );
    console.log("---------");
  }
}
...
if (playCricket.toLowerCase() === "yes") {
  for (var i = 0; i < questions.length; i++) {
    ...
    play(
      ...
      arrayQuestion.answer,
      arrayQuestion.options,
      arrayQuestion.correctAnswer
    );
  }
  ...
  if (score >= highScore.score) {
    ...
    console.log(
      chalk.green.bold(userName) +
        " have beaten high score of " +
        chalk.grey(highScore.name)
    );
    console.log("The Previous highest score was " + chalk.red(highScore.score));
    console.log(
      "Send screenshot to Archit of beating previous score and he will update this in database"
    );
  } else {
    console.log("---------");
